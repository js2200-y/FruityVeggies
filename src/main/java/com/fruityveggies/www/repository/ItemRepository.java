...
public interface ItemRepository extends JpaRepository<Item, Long> {
 ...
 // ItemOption과 Item 엔티티를 조인하는 쿼리 작성
    @Query("SELECT new com.fruityveggies.www.dto.ItemItemOptionDto(a.id, b.name, b.price, a.main_image_path) FROM Item a JOIN ItemOption b on a.id = b.optionId WHERE a.id = :itemId")
